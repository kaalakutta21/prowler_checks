...
def check_rds_ssl_enforcement(session):
    ...
    for region in tqdm(regions, desc="Scanning Regions"):
        ...
        try:
            ...
            if code in ["AuthFailure", "OptInRequired", "InvalidClientTokenId"]:
                print(f"Skipping region {region} during scan")
                continue
            else:
                print(f"Pagination error {region}: {e}")
                continue
